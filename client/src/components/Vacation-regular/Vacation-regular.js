    ...
    render() {
        return (
            <div className="regular-container">
                <div className="regular_vacations_wrapper">
                <div className="header-vacations-reg-wrapper">
                    <div className="row justify-content-center">
                    <h3 className="font-family-Lobster dark-bage-color">What Are We Offering ?</h3>
                    </div>
                    <div className="row justify-content-center margin-top-bottom-small">
                    <p className="col-6 ">
                        Here in Vacations List we help you to find your perfect next vacation.
                        With our wide and varied database you will find the next locatin to enjoy your vacation.
                    </p>
                    </div>
                </div>
...
export default Vacation_regular;